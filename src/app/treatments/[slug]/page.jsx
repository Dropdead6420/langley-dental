  ...
  return (
    <div className="!min-h-screen !bg-gradient-to-br !from-gray-50 !to-blue-50 !py-16 !px-4 sm:!px-6 lg:!px-8">
      <div className="container mx-auto">
        <div className="!max-w-3l !mx-auto !bg-white !p-8 md:!p-10 !rounded-lg !shadow-xl !mt-12">
          <h1 className="!text-4xl !font-extrabold !tracking-tight !text-gray-900 !mb-6 !leading-tight">
            {treatment.title}
          </h1>
