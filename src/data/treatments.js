...
const treatments = [
  {
    ...
    content: `
      ...
      <ul class="list-image-[url(/assets/images/icon/check.svg)]">
        <li>The tooth surface is gently roughened, and a conditioning liquid is applied.</li>
        <li>A tooth-colored resin is molded to the desired shape and hardened with a special light.</li>
        <li>The bonded tooth is polished for a natural finish.</li>
      </ul>
      ...
      <ul class="list-image-[url(/assets/images/icon/check.svg)]">
        <li>Quick and straightforward procedure, often completed in a single visit.</li>
        <li>Cost-effective compared to veneers.</li>
      ...
      <p><strong>Procedure:</strong></p>
      <ul class="list-image-[url(/assets/images/icon/check.svg)]">
        <li>A small amount of enamel is removed to create space for the veneer.</li>
        <li>Impressions of your teeth are taken to create custom veneers.</li>
        <li>The veneers are bonded to your teeth in a follow-up appointment.</li>
      </ul>
      <p><strong>Purpose:</strong></p>
      <ul class="list-image-[url(/assets/images/icon/check.svg)]">
        <li>Address stained or discolored teeth.</li>
        <li>Correct misaligned or irregularly shaped teeth.</li>
        <li>Close gaps between teeth.</li>
      </ul>
      <p><strong>Advantages:</strong></p>
      <ul class="list-image-[url(/assets/images/icon/check.svg)]">
        <li>Provides a natural, aesthetically pleasing appearance.</li>
        <li>Resistant to staining.</li>
  ...
  },
  {
    ...
    content: `
      ...
      <h4>Early Assessments</h4>
      <p>We perform thorough evaluations of tooth and jaw growth to identify and address potential issues early, helping to prevent more complex problems in the future.</p>
      ...
      <ul class="list-image-[url(/assets/images/icon/check.svg)]">
        ...
        <li><strong>Education and Oral Hygiene:</strong> Teaching kids and parents about proper brushing, flossing, and diet for healthy teeth.</li>
        <li><strong>Specialized Techniques:</strong> Using child-friendly methods and tools to make dental visits stress-free.</li>
        <li><strong>Common Pediatric Dental Procedures:</strong> Including cleanings, fluoride treatments, sealants, and cavity fillings.</li>
  ...
  },
  {
    ...
    content: `
      ...
      <ul class="list-image-[url(/assets/images/icon/check.svg)]">
        ...
        <li>Ideal for patients who have lost all their teeth.</li>
        <li>Custom-designed to restore the appearance and function of a full set of teeth.</li>
      </ul>

      <h4>Partial Dentures</h4>
      <ul class="list-image-[url(/assets/images/icon/check.svg)]">
        <li>Used when some natural teeth remain in the upper or lower jaw.</li>
        <li>Fill in gaps created by missing teeth.</li>
      ...
      <ul class="list-image-[url(/assets/images/icon/check.svg)]">
        ...
        <li><strong>Custom Fit:</strong> Designed specifically for your mouth for maximum comfort.</li>
...
:</strong>  Your comfort and satisfaction are our top priorities. We take the time to understand your needs, address your concerns, and deliver a seamless denture experience tailored specifically to you.
  ...
  },
  {
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      <li>Never throw away or lose the tooth. In many cases, it can be reinserted into the socket after proper treatment.</li>
      <li>Place the tooth in a Save-A-Tooth solution or, if unavailable, in cool milk to keep it moist.</li>
      <li>Avoid scraping or cleaning the tooth.</li>
      <li>Call us immediately for emergency care.</li>
    </ul>

    <h4>Toothache or Sensitivity</h4>
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      <li>Persistent pain or sensitivity in a tooth could indicate an underlying issue, such as decay or infection.</li>
      <li>Contact us right away to schedule an emergency appointment.</li>
    </ul>

    <h4>Chipped or Broken Tooth</h4>
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      <li>If you’ve chipped a tooth and need to get back to work or your daily routine, give us a call.</li>
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Lost Filling or Crown:</strong> Keep the area clean and avoid chewing on the affected side. Bring the crown or filling with you to your appointment if possible.</li>
      <li><strong>Dental Abscess:</strong> Rinse with warm salt water to reduce swelling and call us immediately for treatment.</li>
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Experienced Team:</strong> Our skilled professionals are equipped to provide effective and compassionate care.</li>
  ...
  },
  {
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Enhanced Image Quality:</strong> Digital X-rays provide clearer, more detailed images, allowing for accurate detection of dental issues such as cavities, bone loss, and infections.</li>
      <li><strong>Environmentally Friendly:</strong> Eliminates the need for chemical processing, making it a more eco-friendly option.</li>
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Comprehensive Care:</strong> Digital radiography is an integral part of our diagnostic process, helping us provide personalized and effective treatment plans.</li>
  ...
  },
  {
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Spacing:</strong> Gaps between teeth.</li>
      <li><strong>Deep Bite:</strong> Upper teeth excessively overlap the lower teeth.</li>
      <li><strong>Open Bite:</strong> Upper and lower teeth do not meet when the mouth is closed.</li>
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Removable:</strong> Aligners can be easily removed for eating, brushing, and flossing, promoting better oral hygiene.</li>
      <li><strong>Easy Maintenance:</strong> Cleaning the aligners is simple, ensuring a hassle-free experience.</li>
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Advanced Technology:</strong> Our state-of-the-art facility ensures accurate impressions and effective treatment outcomes.</li>
  ...
  },
  {
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Full-Service, Patient-Focused Dentistry:</strong> Comprehensive care tailored to your unique oral health goals.</li>
      <li><strong>Convenient Appointments:</strong> Flexible scheduling to fit your busy lifestyle.</li>
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Treatment Planning:</strong><br>A customized plan outlining the procedures needed to achieve optimal results.</li>
      <li><strong>Preparatory Procedures:</strong><br>Addressing foundational issues such as gum disease, extractions, or bone grafting.</li>
      <li><strong>Restorative Procedures:</strong><br>Replacing missing teeth with dental implants, crowns, or bridges to restore function.</li>
      <li><strong>Orthodontic Interventions:</strong><br>Correcting bite alignment or spacing issues with braces or clear aligners, if necessary.</li>
      <li><strong>Cosmetic Procedures:</strong><br>Enhancing the appearance of your smile with veneers, teeth whitening, or other aesthetic treatments.</li>
  ...
  },
  {
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Full-Service, Patient-Focused Dentistry:</strong> Personalized care tailored to your unique needs.</li>
      <li><strong>Convenient Appointments:</strong> Flexible scheduling to fit your busy lifestyle.</li>
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Aesthetic Appeal:</strong> White fillings blend seamlessly with your natural teeth, giving you a brighter, more confident smile.</li>
  ...
  },
  {
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Safe and Effective Sedation Dentistry:</strong> Perfect for patients with dental anxiety or special healthcare needs.</li>
      <li><strong>Full-Service, Patient-Focused Dentistry:</strong> Personalized care tailored to your unique goals.</li>
      <li><strong>Convenient Appointments:</strong> Flexible scheduling to fit your busy lifestyle.</li>
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Porcelain Veneers:</strong><br>Veneers are custom-made porcelain shells bonded to the front of your teeth. They address issues like chips, cracks, gaps, and severe discoloration, providing a durable and natural-looking enhancement.</li>
      <li><strong>Dental Bonding:</strong><br>A cost-effective solution for minor imperfections, dental bonding uses tooth-colored resin to repair chips, gaps, and irregularities, giving your teeth a flawless finish.</li>
  ...
  content: `
    ...
    <ul>
      ...
      <li>Habits to avoid (smoking, high-sugar diets, etc.)</li>
    </ul>
...
:</strong>  If dental anxiety, fear of procedures, or special healthcare needs make dental visits difficult, our sedation dentistry options can help. We offer safe and effective sedation methods to ensure a relaxed and pain-free experience, allowing you to receive essential treatment with confidence.
...

  {
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Gummy Smile Correction:</strong><br>Botox can be used to relax the upper lip, reducing the appearance of a gummy smile and creating a more balanced look.</li>
      <li><strong>Orthodontic Treatment:</strong><br>Botox can assist in managing muscle-related issues during or after orthodontic treatment, improving overall results.</li>
  ...
  },
  {
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Tartar Removal/Scaling:</strong><br>Professional cleaning to remove plaque and tartar buildup, preventing gum disease.</li>
      <li><strong>Sealants:</strong><br>Protective coatings applied to teeth to prevent cavities, especially in children.</li>
      <li><strong>Fluoride Treatments:</strong><br>Strengthen enamel and protect against decay.</li>
      <li><strong>X-Rays:</strong><br>Advanced imaging to detect hidden dental problems.</li>
      <li><strong>Night Guards and Sports Guards:</strong><br>Custom-fitted guards to protect your teeth from grinding or sports-related injuries.</li>
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Safe and Effective Sedation Dentistry:</strong> Perfect for patients with dental anxiety or special healthcare needs.</li>
      <li><strong>Full-Service, Patient-Focused Dentistry:</strong> Personalized care tailored to your unique oral health goals.</li>
      <li><strong>Convenient Appointments:</strong> Flexible scheduling to fit your busy lifestyle.</li>
      <li><strong>Caring Dental Professionals:</strong> Our team is dedicated to your comfort and well-being.</li>
    </ul>
  ...
  },
  {
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Durable and Long-Lasting:</strong> With proper care, crowns and bridges can last for many years, providing a reliable solution for dental restoration.</li>
  ...
  },
  {
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Surgical Placement:</strong> The titanium implant is surgically placed into the jawbone, serving as the foundation for your new tooth.</li>
      <li><strong>Osseointegration:</strong> Over several months, the implant fuses with the jawbone, ensuring a stable and secure fit.</li>
      <li><strong>Abutment Placement:</strong> A small connector (abutment) is attached to the implant to hold the replacement tooth.</li>
      <li><strong>Impressions and Restoration:</strong> Impressions are taken to create a custom crown, bridge, or denture that matches your natural teeth.</li>
      <li><strong>Final Placement:</strong> The restoration is securely attached to the abutment, completing your new smile.</li>
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Preservation of Jawbone:</strong> Prevent bone loss and maintain facial structure.</li>
      <li><strong>Longevity:</strong> With proper care, implants can last a lifetime.</li>
      <li><strong>Speech Improvement:</strong> Eliminate slurring or discomfort caused by missing teeth.</li>
      <li><strong>Enhanced Comfort:</strong> Implants are secure and don’t shift like dentures.</li>
      <li><strong>Preservation of Adjacent Teeth:</strong> Unlike bridges, implants don’t rely on neighboring teeth for support.</li>
      <li><strong>Boosted Confidence:</strong> Restore your smile and self-esteem.</li>
      <li><strong>Convenience and Easy Maintenance:</strong> Care for implants just like natural teeth.</li>
  ...
  },
  {
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li>Overcrowding in preparation for orthodontic treatment</li>
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li>Prevent complications like bone loss and gum recession</li>
      <li>Create a stable foundation for future dental implants</li>
    </ul>
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li>Keeping the area clean and free of debris</li>
  ...
  },
  {
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Cleaning and Shaping the Root Canals:</strong> The canals are thoroughly cleaned and shaped to prepare for sealing.</li>
      <li><strong>Sealing the Tooth:</strong> The canals are sealed with a biocompatible material to prevent reinfection.</li>
      <li><strong>Restoring the Tooth:</strong> A crown or filling is placed to restore the tooth’s function and appearance.</li>
    </ul>
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li>A recurring pimple on the gums</li>
    </ul>
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Restore Function:</strong> Regain the ability to chew and speak comfortably.</li>
  ...
  },
  {
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Boosted Confidence:</strong> A whiter smile can enhance your self-esteem and leave a lasting impression.</li>
  ...
  },
  {
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Safe and Effective Sedation Dentistry:</strong> Perfect for patients with dental anxiety or special healthcare needs.</li>
      <li><strong>Full-Service, Patient-Focused Dentistry:</strong> Personalized care tailored to your unique goals and preferences.</li>
      <li><strong>Convenient Appointments:</strong> Flexible scheduling to fit your busy lifestyle.</li>
      <li><strong>Caring Dental Professionals:</strong> Our team is committed to your comfort and satisfaction.</li>
    </ul>
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Customized Treatment Plan:</strong> A detailed plan outlining the combination of cosmetic and restorative procedures tailored to your needs.</li>
      <li><strong>Cosmetic Treatments:</strong> Options may include teeth whitening, porcelain veneers, dental bonding, or gum contouring to enhance the appearance of your smile.</li>
      <li><strong>Restorative Procedures:</strong> Treatments like crowns, bridges, or dental implants to restore function and aesthetics.</li>
      <li><strong>Orthodontic Solutions:</strong> Address alignment issues with braces or clear aligners for a straighter smile.</li>
    ...
    <ul class="list-image-[url(/assets/images/icon/check.svg)]">
      ...
      <li><strong>Boosted Confidence:</strong> Feel more self-assured in social and professional settings.</li>
      <li><strong>Improved Oral Health:</strong> Address underlying dental issues for a healthier mouth.</li>
      <li><strong>Customized Treatment:</strong> Tailored to your unique needs and goals.</li>
      <li><strong>Functional Improvements:</strong> Restore the ability to chew, speak, and smile comfortably.</li>
      <li><strong>Long-Lasting Results:</strong> Enjoy a beautiful smile for years to come.</li>
  ...
  },
{
  ...
  content: `
    ...
    <ul>
      ...
      <li>Have had traumatic dental experiences in the past</li>
      <li>Require extensive or complex dental treatments</li>
      <li>Have a low pain threshold or sensitive teeth</li>
    ...
    <ul>
      ...
      <li><strong>Time Efficiency:</strong> Multiple procedures can often be completed in a single visit, saving time and reducing the need for multiple appointments.</li>
  ...
  // Add more treatments with `slug`, `title`, `image`, and `content`...
];
